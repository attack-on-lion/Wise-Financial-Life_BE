...
public enum ErrorCode {
    ...
    NVALID_LOGO_URL(HttpStatus.BAD_REQUEST, "4027", "로고 URL은 필수 입력 항목입니다."),
    INVALID_STORE_NAME(HttpStatus.BAD_REQUEST, "4028", "가게 이름은 필수 입력 항목입니다."),
    INVALID_LOGO_URL_FORMAT(HttpStatus.BAD_REQUEST, "4029", "로고 URL 형식이 올바르지 않습니다."),
    INVALID_CATEGOR(HttpStatus.BAD_REQUEST, "4030", "카테고리는 필수입니다."),
    INVALID_GIFTICON_NAME(HttpStatus.BAD_REQUEST, "4031", "기프티콘 이름이 유효하지 않습니다."),
    INVALID_GIFTICON_PRICE(HttpStatus.BAD_REQUEST, "4032", "기프티콘 가격이 유효하지 않습니다."),
    INVALID_GIFTICON_IMAGE_URL(HttpStatus.BAD_REQUEST, "4033", "기프티콘 이미지 URL이 유효하지 않습니다."),
    INVALID_GIFTICON_EXPIRED_AT(HttpStatus.BAD_REQUEST, "4034", "기프티콘 만료 시간이 유효하지 않습니다."),
    INVALID_GIFTICON_IS_RECOMMEND(HttpStatus.BAD_REQUEST, "4035", "기프티콘 추천 여부가 유효하지 않습니다."),
    INVALID_GIFTICON_PRICE_POSITIVE(HttpStatus.BAD_REQUEST, "4036", "기프티콘 가격은 0보다 커야 합니다."),
    ...
    POINT_HISTORY_NOT_FOUND(HttpStatus.NOT_FOUND, "40411", "포인트 내역이 존재하지 않습니다."),
    GIFTICON_NOT_FOUND(HttpStatus.NOT_FOUND, "40412", "기프티콘에 대한 정보를 찾을 수 없습니다."),
    STORE_NOT_FOUND(HttpStatus.NOT_FOUND, "40413", "스토어 정보를 찾을 수 없습니다."),
